...
** File and URL mappings fallback to revision of docgen.xml at each
...
* Pages can be grouped with table of contents of per page entries
...
* Loaded by client browser with fallback copy added to vendor directory of
  generated site.
...
* Copied to vendor subdirectory of generated site.
** https://prismjs.com[prismjs] 1.30.0
