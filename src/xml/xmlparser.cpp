...
bool XStreamParser::parseNode(
    ...
    case kUtf8Lead2:
        return twoByte(ptr, &utf8) ? parseElement(notify, ptr, ptr + 2, utf8)
                                   : fail("invalid utf-8 encoding");
    case kUtf8Lead3:
    case kUtf8BomIntro:
        return threeByte(ptr, &utf8) ? parseElement(notify, ptr, ptr + 3, utf8)
                                     : fail("invalid utf-8 encoding");
    case kUtf8Lead4:
        return fourByte(ptr, &utf8) ? parseElement(notify, ptr, ptr + 4, utf8)
                                    : fail("invalid utf-8 encoding");
    case kColon:
    case kAlpha:
    case kHexAlpha:
