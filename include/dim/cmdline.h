...
public:
    CmdArg(
        const std::string & name, const T & def = T{}, bool required = false);
    CmdArg(
        CmdParser * p,
        T * value,
